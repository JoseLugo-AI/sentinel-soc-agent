...
**On gap detection (>2 hours):** Query the missed window, but cap the catch-up query at **24 hours**. Gaps exceeding 24 hours are logged as `GAP_EXCEEDED` in triage.jsonl:
```json
